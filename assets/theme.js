...
slate.Variants = (function() {
  ...
  Variants.prototype = Object.assign({}, Variants.prototype, {
    ...
    // This updates details in real time
...
if (state.item_count === 0) {
              ...
              this._createCart(state);/** Bold Removed
  ...
  Product.prototype = Object.assign({}, Product.prototype, {
    ...
    _addItemToCart: function(form) {
      ...
      fetch(this.cartRoutes.cartAddUrl + '.js', {
        method: 'POST',
        credentials: 'same-origin',/** Bold Removed
...
*/body:window.FormData ? new FormData(form) :  theme.Helpers.serialize(form)
      })
        .then(function(response) {
          return response.json();
        })
